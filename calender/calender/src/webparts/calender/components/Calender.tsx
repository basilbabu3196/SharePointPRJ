...
return<div>
    ...
    {showText ? <Model handleClose={hideModal} monthdat={monthdata} cyear={years} dates={dates} /> : null}

    {showTextve ? <Modeleve handleCloses={hideModale} edate={endDate} yea={years}  da={day} mont={dt.getMonth()} /> : null}
